...
function App() {
  ...
  const [weatherIcon,setWeatherIcon]=useState('https://s3-us-west-2.amazonaws.com/s.cdpn.io/162656/0n@2x.png');
        ...
        <div className="lg:w-2/4 p-5">
          ...
          <div className="flex flex-col my-10">
            ...
            {weatherData.length === 0 ? 
              ...
              <>
                <h1 className="text-center sm:text-left text-3xl lg:text-5xl text-gray-800 mt-auto mb-4">Today</h1>
                <DetailCard weather_icon={weatherIcon} data={weatherData} />
                <h1 className="text-center sm:text-left text-3xl text-gray-600 mb-4 mt-10">More On {city}</h1>
